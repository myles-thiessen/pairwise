...
public class MessageTimerManager implements IMessageTimerManager {
  private final Map<Pair<Object, Object>, List<Long>> messageTimes =
      new HashMap<>();

  @Override
  public void recordMessageTime(final Object process, final Object operation,
                                final long time) {
  }

  @Override
  public List<Long> getMessagesTimes(final Object process,
