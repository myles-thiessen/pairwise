...
public class FullyConnectedRouter implements IRouter {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(FullyConnectedRouter.class);

  private final Map<Object, ILink> links = new HashMap<>();

  @NonNull
  private final IUniqueNumberGenerator broadcastIdentifierManager;
  @Getter
  @NonNull
  private final IRouterState routerState;

  @Getter
  @NonNull
  private final IMessageTimerManager messageTimerManager;
  ...
  @Override
  public void registerRouter(final Object identifier,
                             final ILink linkToRouter) {
  ...
  public int broadcastRequest(
      ...
      final boolean async) {
    return this.broadcastPersonalizedRequest(processes, operation,
  ...
  public int broadcastPersonalizedRequest(
    ...
    for (Object identifier : processes) {
      Optional<ILink> optionalIRouterProcess =
          this.getRouterByIdentifier(identifier);
  ...
  public void handleRequest(
    ...
    Object response =
        this.handleRequestWithResponse(sender, operation,
            broadcastRequestNumber, time, request);
    Object senderIdentity = this.getRouterState().getIdentifier();

    senderRouter.handleResponse(senderIdentity, operation,
        broadcastRequestNumber, time, response);
  }
  ...
  public Object handleRequestWithResponse(
    ...
    IRequestHandler requestHandler =
        this.getRouterState().getRequestHandlerForOp(operation);
  ...
  public void handleResponse(
    ...
    IResponseHandler responseHandler =
        this.getRouterState().getResponseHandlerForOp(operation,
            broadcastRequestNumber);
