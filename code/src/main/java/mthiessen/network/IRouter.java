...
public interface IRouter {
  ...
  default int broadcastRequestToAll(final Object operation,
  ...
  default int broadcastRequestToAll(
    ...
    return this.broadcastRequest(this.getAllRegisteredRoutes(), operation,
        request, async);
  }

  default int broadcastRequest(
      final Collection<?> processes, final Object operation,
      final Object request) {
  ...
  default int broadcastPersonalizedRequestToAll(
    ...
    return this.broadcastPersonalizedRequestToAll(operation, requestFactory,
        false);
  }
  ...
  BroadcastResponse waitForResponse(final Object operation,
                                    final int broadcastRequestNumber);
}
