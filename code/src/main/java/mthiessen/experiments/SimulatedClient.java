...
public class SimulatedClient {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SimulatedClient.class);
  ...
  private final int outstandingLimit = 100;
  ...
  private void schedule() {
    ...
    if (this.writePercentage <= 0) {
      ...
      int numWrites =
          (int) (this.numberOfOps / (this.numberOfOps * this.writePercentage));

      write = op % numWrites == 0;
    }
