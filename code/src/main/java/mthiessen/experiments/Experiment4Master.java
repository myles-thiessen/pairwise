...
public class Experiment4Master {
  ...
  private static void startUniformWorkload() {
    ...
    // The condition is because PQL will not make progress on any follower if
    // the write frequency is to high so in those cases we don't bother waiting.
    CountDownLatch latch =
        new CountDownLatch(PROTOCOL.equals("PQL") && DELAY < 150 ? 1 : N);
