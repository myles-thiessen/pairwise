...
public class CommitCache {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(CommitCache.class);

  private final Map<Integer, Pair<Payloads.WriteRequest, Pair<Object,
      Integer>>> cache =
      new TreeMap<>();

  public List<Pair<Payloads.WriteRequest, Pair<Object, Integer>>> getCachedCommitsFromIndex(
      final int index) {

    List<Pair<Payloads.WriteRequest, Pair<Object, Integer>>> response =
        new LinkedList<>();
    ...
    for (Map.Entry<Integer, Pair<Payloads.WriteRequest,
        Pair<Object, Integer>>> entry :
        this.cache.entrySet()) {
