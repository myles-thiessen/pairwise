...
public class WriteRecorder implements IWriteRecorder {
  ...
  private final Map<Integer, Payloads.WriteRequest> requests =
      new ConcurrentHashMap<>();

  @Override
  public void setRequest(final int index, final Payloads.WriteRequest request) {
    this.lock.lock();
  ...
  @Override
  public Payloads.WriteRequest waitAndGetRequest(final int index) {
    this.lock.lock();
    ...
    Payloads.WriteRequest request = this.requests.get(index);
