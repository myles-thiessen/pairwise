...
public class LeaderReads extends ReadSynchronizer implements IReadOp {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(LeaderReads.class);

  @NonNull
  private final IRouter router;

  @NonNull
  private final Runnable leaderElectionOp;

  @NonNull
  private final ILeaderElectionService leaderElectionService;

  @NonNull
  private final IProposerState proposerState;
  ...
  public Object read(final Object readReq,
    ...
    if (!this.proposerState.isLeader()) {
      ...
      value = super.read(this.processState, this.stateMachine, readReq,
  ...
  private Object forwardRead(
    ...
    MetricsAttachedRequest<Object> forwardReadRequest =
        new MetricsAttachedRequest<>(readReq,
    ...
    BroadcastResponse response = this.router.waitForResponse(OPS.FORWARD_READ
        , broadcastIdentifier);
