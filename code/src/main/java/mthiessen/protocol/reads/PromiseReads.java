...
public class PromiseReads extends ReadSynchronizer implements IReadOp {
  ...
  public Object read(final Object readReq,
    ...
    return super.read(this.processState, this.stateMachine, readReq,
  ...
  protected int stampRead() {
    ...
    if (this.processState.getLatestVotedForIndex() == this.processState.getLatestCommittedIndex()) {
      ...
      for (int i = read + 1; i <= this.processState.getMaxPendingIndex(); i++) {
