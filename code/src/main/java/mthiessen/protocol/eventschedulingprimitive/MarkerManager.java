...
public class MarkerManager {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(MarkerManager.class);

  private final AtomicInteger versionCounter = new AtomicInteger(0);

  private final Map<Object, Integer> latestEstablishedVersion =
      new ConcurrentHashMap<>();

  private final Map<Object, Map<Integer, Marker>> grantedMarker =
      new ConcurrentHashMap<>();

  private final Map<Object, Map<Integer, Marker>> heldMarker =
      new ConcurrentHashMap<>();
  ...
  public void setGrantedMarker(final Object holder, final long time,
                               final int version) {
    long t = System.currentTimeMillis();

    Map<Integer, Marker> markerMap =
        this.grantedMarker.computeIfAbsent(holder,
  ...
  public void setHeldMarker(final Object granter, final int version) {
    long t = System.currentTimeMillis();
    Map<Integer, Marker> markerMap =
        this.heldMarker.computeIfAbsent(granter,
            (k) -> new ConcurrentHashMap<>());
