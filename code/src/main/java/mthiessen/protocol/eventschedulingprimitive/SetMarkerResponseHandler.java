...
public class SetMarkerResponseHandler extends CountBasedBlockingResponseHandler {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SetMarkerResponseHandler.class);
  ...
  public SetMarkerResponseHandler(
    ...
    super(numberOfProcesses, numberOfProcesses, 0);
  ...
  protected Status process(final Object sender, final Object response) {
    ...
    this.markerManager.setGrantedMarker(sender, markerRequest.time(),
        markerRequest.version());
