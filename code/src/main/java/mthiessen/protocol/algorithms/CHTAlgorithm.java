...
import mthiessen.protocol.reads.CHTLocalReads;
...
public class CHTAlgorithm extends BaseProcess {
  ...
  public static IProcess generate(
    ...
    IReadOp readOp = new CHTLocalReads(proposerState, processState,
        stateMachine);
