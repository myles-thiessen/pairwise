...
import mthiessen.protocol.reads.INVReads;
...
import mthiessen.protocol.state.process.INVProcessState;
...
public class INV extends BaseProcess {
  ...
  public static IProcess generate(
    ...
    IProcessState processState = new INVProcessState();
    ...
    IReadOp readOp = new INVReads(proposerState, processState, stateMachine);
