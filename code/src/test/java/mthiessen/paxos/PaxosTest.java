...
public class PaxosTest {
  public static final Variant variant = Variant.US2;
    ...
    Function<IRouter, IProcess> nodeProduce =
        (router) ->
            AlgorithmFactory.getAlgorithm(
                variant, nodeIdentifiers.get(0), router, new IntegerStateMachine());
